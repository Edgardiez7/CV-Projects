...
public class UserManagement {
    ...
    public List<User> getUsers(@RequestParam(required = false) String enabled,
        ...
        if (enabled == null && email == null) {
            return repository.findAll();
        } else if (enabled != null && email != null) {
            throw new UserException("Wrong fields at enabled param: " + enabled + "-" + email + ".");
        } else if (enabled != null && enabled.equals("true")) {
